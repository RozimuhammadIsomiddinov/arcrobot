...
import MultiFileUpload from '../components/create/blog'
...
import siteEdit from '../components/edit/sites'
AdminJS.UserComponents.siteEdit = siteEdit
import sitesByID from '../components/show/orde.id'
AdminJS.UserComponents.sitesByID = sitesByID
import blogList from '../components/show/blog'
AdminJS.UserComponents.blogList = blogList
import blogEdit from '../components/edit/blog'
